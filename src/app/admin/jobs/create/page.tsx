...
import { Card, CardContent, Button, Input, Textarea, Badge, RichTextEditor } from '@/components/ui';
...
export default function CreateJobPage() {
  ...
  // 验证表单
  const validateForm = () => {
    const { title, department, location, description, requirements, responsibilities } = state.formData;
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">发布职位</h1>
            <p className="text-gray-600 mt-1">创建新的招聘职位</p>
          </div>
        </div>
        <div className="flex gap-3">
          <Button
